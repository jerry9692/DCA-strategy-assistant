...
> **进度（2026-05-23 更新）**：P0（A1-A6）+ P1（B1-B4）+ P2 第一档（C2/C4/C5/C6）+ C3 已合到 main。
> 
...
- **完成情况**：C1-US 第一批已完成。新增核心宽基、红利价值、国际股票、债券防守、商品替代和高级/高波动 ETF，共 26 个内置美股 ETF。前端按分组展示，高波动/杠杆/比特币 ETF 显示风险提示。A 股指数 ETF 后续单独作为市场适配层处理。
