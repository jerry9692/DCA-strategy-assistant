...
export type ServerLlmConfigResponse = Schemas["ServerLlmConfigResponse"];
export type ServerLlmConfigUpdate = Schemas["ServerLlmConfigUpdate"];
export type LlmSource = "local" | "server";
